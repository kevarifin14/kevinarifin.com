...
date: "2022-04-07"
excerpt: Become a CSS expert with utility classes that allow you to 
...
It's helpful to define `primary`, `dark`, and `light` colors in your Tailwind config to easily set and update a theme across your whole application. 

`primary` defines the main color for your whole application. `dark` and `light` allow you to set a foundation for dark mode and make it seamless to configure. 
